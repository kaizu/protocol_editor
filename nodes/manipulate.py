...
class StoreLabwareNode(BuiltinNode):
    ...
    def __init__(self):
        ...
        self.add_input_w_traits("in1", entity.Labware, expand=True, optional=True)
    ...
    def _execute(self, input_tokens):
        ...
        if input_tokens["in1"]["value"] is not None:
            if where == "":
...
class DispenseLiquid96WellsNode(BuiltinNode):
    ...
    def __init__(self):
        ...
        self.add_input_w_traits("in1", entity.Plate96, expand=True, optional=True)
        self.add_output_w_traits("out1", entity.Plate96, expand=True, expression="in1", optional=True)
    ...
    def _execute(self, input_tokens):
        if input_tokens["in1"]["value"] is None:
...
class ReadAbsorbance3ColorsNode(BuiltinNode):
    ...
    def __init__(self):
        ...
        self.add_input_w_traits("in1", entity.Plate96, expand=True, optional=True)
        self.add_output_w_traits("out1", entity.Plate96, expand=True, expression="in1", optional=True)
        self.add_output_w_traits("value", entity.Spread[entity.Array[entity.Float]], expand=True, expression="Spread[Array[Float]]", optional=True)
